...
import 'delete_confirmation_dialog.dart';
  ...
  void showProductDetailsBottomSheet(BuildContext context, ShelfItem item, ShelfViewModel shelfVm) {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  buildDetailMetric(context, 'PRICE', '\$${price.toStringAsFixed(2)}'),
                  buildDetailMetric(context, 'USES REMAINING', '$remainingUses / $estimatedUses'),
                  buildDetailMetric(context, 'COST PER USE', '\$${costPerApply.toStringAsFixed(2)}'),
                ],
              ),
              const SizedBox(height: 24),
              const Text(
