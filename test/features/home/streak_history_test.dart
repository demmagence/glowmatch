...
void main() {
  ...
  group('SupabaseService Daily Completion Logs', () {
    test(
      'getDailyCompletionLogs returns empty initially when no logs',
      () async {
  ...
  group('RoutineViewModel Streak Segment Calculation', () {
    ...
    test(
      'streakSegments correctly groups contiguous dates and ignores duplicates',
      () async {
        ...
        svc.setMockDailyCompletionLogs('test-user', [
          day1,
          day2,
          day3,
          day4,
